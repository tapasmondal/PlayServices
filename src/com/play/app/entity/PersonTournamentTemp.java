...
@Entity(name="persontournament") @IdClass(PersonTournamentId.class)
public class PersonTournamentTemp implements Comparable<PersonTournamentTemp>{
...
/*
	...
	@Override
	public int compareTo(PersonTournamentTemp o) {
